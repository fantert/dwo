...
console.log('card.js: Odczytano z sessionStorage:', sessionStorage.getItem('formData'));
...
if (sessionStorage.getItem('formData')) {
    ...
    console.log('card.js: Obiekt data:', data);
} else {
    console.log('card.js: Brak danych w sessionStorage.');
    var data = {}; // Inicjalizuj pusty obiekt, aby uniknąć błędów
}
