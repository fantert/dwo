...
var params = new URLSearchParams(sessionStorage.getItem('formData'));
console.log('id.js: Odczytano z sessionStorage:', sessionStorage.getItem('formData'));
...
if (sessionStorage.getItem('formData')) {
    ...
    console.log('id.js: Obiekt data:', data);
} else {
    console.log('id.js: Brak danych w sessionStorage.');
}
...
function toHome(){
    console.log('id.js: Przekierowanie do home.html');
    location.href = 'https://fantert.github.io/dwo/home.html';
}
